...
export default function CreateTopicScreen() {
  ...
  // Estados baseados no Prisma: Topic
  ...
  const handleCreate = () => {
    console.log({ title, content, image, selectedCommunityId });
    // router.back();
  };
    ...
    <View style={globalStyles.scrollContainer}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Título do Tópico <Text style={styles.required}>*</Text></Text>
          <TextInput
            style={styles.input}
            placeholder="Ex: Dicas para lidar com a ansiedade"
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Vincule uma comunidade <Text style={styles.required}>*</Text></Text>
          <SelectWithIcon
            data={communitiesData}
            placeholder="Vincule uma comunidade..."
            iconLeftName="users"
            value={selectedCommunityId}
            onChange={(item) => setSelectedCommunityId(item.value)}
          />
        </View>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            placeholder="Escreva os detalhes do seu tópico aqui..."
            placeholderTextColor="#999"
            multiline
            numberOfLines={6}
            maxLength={2000}
      ...
      <View style={styles.footer}>
        ...
        >
          <Text style={styles.primaryButtonText}>Criar Tópico</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
